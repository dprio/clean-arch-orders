...
func (_mock *MockOrderRepository) Save(ctx context.Context, order *domain.Order) (domain.Order, error) {
...
func (_c *MockOrderRepository_Save_Call) Run(run func(ctx context.Context, order *domain.Order)) *MockOrderRepository_Save_Call {
...
func (_c *MockOrderRepository_Save_Call) Return(order1 domain.Order, err error) *MockOrderRepository_Save_Call {
	_c.Call.Return(order1, err)
	return _c
}

func (_c *MockOrderRepository_Save_Call) RunAndReturn(run func(ctx context.Context, order *domain.Order) (domain.Order, error)) *MockOrderRepository_Save_Call {
	_c.Call.Return(run)
	return _c
}
